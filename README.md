...
[1] N. McLaughlin, et al. ※Deep android malware detection,§ in CODASPY＊17. ACM, 2017, pp. 301每308.

[2] D. Chaulagain, et al. ※Hybrid analysis of android apps for security vetting using deep learning,§ in CNS＊20. IEEE, 2020, pp. 1每9.

[3] T. S. John, et al. ※Graph convolutional networks for android malware detection with system call graphs,§ in ISEA-ISAP, 2020, pp. 162每170.

[4] A. Pektas and T. Acarman, ※Learning to detect android malware via opcode sequences,§ Neurocomputing, vol. 396, pp. 599每608, 2020.
