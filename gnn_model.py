...
class Hybrid_Network(nn.Module):
    def __init__(self, feat_dim, stat_dim, T, lstm_feature):
        ...
        n = lstm_feature.shape[0]
        self.sum = sum_net(num = n)
